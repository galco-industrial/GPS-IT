...
function getMessage(divName) {
    ...
    if (divName == "moClick") {return "Click this button to Delete this item.";}
   return "";
}
...
<!--
                    for (var i = 0; i < iS; i++){
                            ...
                            document.write(" name=\"B4\" onclick=\"Javascript: window.location='gpsbdf3.do?familyCode=");
