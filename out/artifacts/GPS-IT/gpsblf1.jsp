...
<form name="form1" action="gpsblf2.do" method=post onsubmit="return My_Validator()">
        <p>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Select the Product Line and Family that this Subfamily belongs to.
                    </p><br />
                </td>
            </tr>
