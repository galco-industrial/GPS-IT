...
<head>
	...
	<title>Galco Parametric Search - Modify Subfamily Codes</title>
...
<form name="form1" action="gpsbmf2.do" method=post onsubmit="return My_Validator()">
        <p>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Select the Product Line and Family for the Subfamily you wish to modify.
                    </p><br />
                </td>
            </tr>
