...
<form method="post" name="form1" action="gpsdvf4.do" onsubmit="return myValidator()" >
<p>
    <input type="hidden" name="validation" value="Error" />
    <input type="hidden" name="partNumber" value="" />
    <input type="hidden" name="manufacturerDescription" value = "" />
    <input type="hidden" name="familyDescription" value = "${sessionScope.familyDescription}" />
    <input type="hidden" name="subfamilyDescription" value = "${sessionScope.subfamilyDescription}" />
    <input type="hidden" name="manCode" value = "${sessionScope.manCode}" />
    <input type="hidden" name="familyCode" value = "${sessionScope.familyCode}" />
    <input type="hidden" name="subfamilyCode" value = "${sessionScope.subfamilyCode}" />
</p>
...
<!--  Family Description  -->
    ...
    <tr>
      ...
      <td align="left" width="25%"><span class="headerData">
        ...
        ${sessionScope.familyDescription}
...
<!--  Subfamily Description  -->
      ...
      <td align="right" width="25%"><span class="headerLabel">
        ...
        <td align="left" width="25%"><span class="headerData">
         ...
         ${sessionScope.subfamilyDescription}
...
<!--
    if (f != 0)  {
        ...
        document.write("<td align=\"center\">Display</td>");
    ...
    for (var i = 0; i < f; i++){
        ...
        document.write("<a target=\"_blank\" href=\"gpsdrf1.do?partNum=");
        document.write(escape(aPartNum[i]) + "\" >");
...
<!--  Continue or Clear  -->
      ...
      <tr>
		...
		<br />
          <center>
            <input type="button" value="Start Over" name="B3" onclick='JavaScript: location.href="gpsdvf1.do";' 
