<%-- 
    Document   : gpsmmf2
    Created on : Oct 23, 2013, 3:30:13 PM
    Author     : dunlop
--%>
...
<!--
        ...
        function checkModify() {
            var myForm = document.form1;
            var work1 = myForm.oldActive.value.charAt(0);
            var work2 = myForm.active.value.charAt(0);
            if (work1 != work2) {
...
//--> 
        ...
        <form name="form1" action="gpsmmf3.do" method=post onsubmit="return My_Validator()">
...
%> 
                    ...
                    <td align="center" width="80%">
                        <h2>
                            Parametric Search<br />Modify Manufacturer Alias
                        </h2>
                    </td>
                </tr>
                <tr>
