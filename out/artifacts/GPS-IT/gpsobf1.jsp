...
<head>
	...
	<title>Galco Parametric Search - Build Select Box Options</title>
...
function getMessage(divName) {
    ...
    if (divName == "moContinue") {return "Click Continue to select a field Rule Set for this Option Build.";}
...
<form name="form1" action="gpsobf2.do" method="post" onsubmit="return My_Validator()">
        <p>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Select the Product Line/Family/Subfamily codes for the parm field select box options
                    you wish to Build.
                    </p><br />
                </td>
            </tr>
        ...
        <td colspan="2">
          <center>
            ...
            <input type="button" 
                value="&nbsp;&nbsp;&nbsp;&nbsp;Exit&nbsp;&nbsp;&nbsp;&nbsp;" 
                name="B3" 
                onclick="Javascript: window.location='gpsof.jsp'; " 
