...
<head>
	...
	<title>Galco Parametric Search - Delete Select Box Option(s)</title>
...
function getMessage(divName) {
    ...
    if (divName == "moContinue") {return "Click Continue to select an Option to Delete.";}
    ...
    if (divName == "moSelectBoxName") {return "Choose a Select Box that contains the Option to be deleted.";}
...
function selectBoxNamesXMLParser() {
    ...
    for (var i = 0; i < results.length; i++) {
        ...
        if (initialize) {
            if (prevSelectBoxName == selectBox) {
                oOption.setAttribute("selected", true);
            }
        }
        oListbox.appendChild(oOption);    
    ...
    if (oListbox.options.length < 2) {
        alert ("No Select Boxes exist for this Family/Subfamily.");
...
<body onload="setDefaults()">
    ...
    <!--
        ...
        var prevSelectBoxName = "${sessionScope.sbSelectBoxName}";
...
<form name="form1" action="gpsodf2.do" method="post" onsubmit="return My_Validator()">
        <p>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>First choose a Select Box that contains the Option(s) you wish to delete.
                    </p><br />
                </td>
            </tr>
