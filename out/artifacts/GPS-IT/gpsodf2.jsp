...
function getMessage(divName) {
    if (divName == "moClick") {return "Click to Delete this Option.";}    
    ...
    if (divName == "moSelectBoxName") {return "The Select Box Name that contains the option to be deleted.";}  
...
<!--
                for (var i = 0; i < options.length; i++){
                    ...
                    document.write(" name=\"B4\" onclick=\"Javascript: window.location='gpsodf3.do?selectBoxName=");
