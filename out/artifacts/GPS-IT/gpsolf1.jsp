...
<head>
	...
	<title>Galco Parametric Search - List Select Box Options</title>
...
function getMessage(divName) {
    ...
    if (divName == "moList") {return "Click to List the Options in a Select Box.";}
...
<form name="form1" action="gpsolf2.do" method=post onsubmit="return My_Validator()">
        <p>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Choose a Select Box whose Options you wish to List.
                    </p><br />
                </td>
            </tr>
