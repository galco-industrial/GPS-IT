...
<head>
	...
	<title>Galco Parametric Search - Display Select Box Option</title>
...
<!--     Continue      -->
      ...
      <tr>
        <td colspan="2">
          <center>
            <br />
            <input type="button" value="&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;" name="B9" onclick="Javascript: window.location='gpsotf1.do'; " 
...
<!--     Exit      -->
          ...
          <br /><br /><br />
<p><center>
                <input type="button" value="&nbsp;&nbsp;&nbsp;&nbsp;Exit&nbsp;&nbsp;&nbsp;&nbsp;" name="B3" onclick="Javascript: window.location='gpsotf2.do'; " 
                    onmouseover="showTip(event, 'moExit')" 
                    onmouseout="hideTip()"
                /></center>
