...
<head>
	...
	<title>Galco Parametric Search - Create Rule Set Part 3S</title>
...
function getMessage(divName) {
    if (divName == "header"){return "To change the Rule Scope, Line/Family/Subfamily name, Data Type, or the Field Number, you must start over.";}
    ...
    if (divName == "moContinue"){return "Click to finish creating this rule set.";}
...
<!-- Logo and Heading  -->
  ...
  <tr>
	...
	<h2>
        Parametric Search Rules Maintenance - Create Rule Set - Part 3S
	</h2>
    </td>
  </tr>
  <tr>
...
//-->
                        ...
                        <td>
                            <select name="deSelectBoxName" size="1"
                                ...
                                onmouseout="hideTip()">
                                <option selected="selected" value="0">Choose a Select Box</option>
                                <script language="JavaScript" type="text/javascript">
                                <!--
