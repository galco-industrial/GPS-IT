...
<head>
	...
	<title>Galco Parametric Search - Modify Rule Set</title>
	<link type="text/css" rel="stylesheet" href="gpsrules.css" />
        ...
        02/16/2010      DES     Added Search and Display Order
...
function getMessage(divName) {
    ...
    if (divName == "moClick") {return "Click to Modify the Rule Set for this field.";}
...
%> 
			...
			Modify Family/Subfamily Rule Set
                </h2>
            </td>
        </tr>
        <tr>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Click the desired Rule to Modify it.
                    </p><br />
                </td>
            </tr>
...
<!-- Product Subfamily -->
    ...
    <table border="1" align="center" width="100%">
            ...
            <tr>
                ...
                <td width="5%">
                    <span class="requiredLabel">Srch<br />Order</span>
                </td>
                <td width="5%">
                    <span class="requiredLabel">Disp<br />Order</span>
                </td>
                <td width="5%">
...
<!--
            if (rules.length > 0) {
                for (var i = 0; i < rules.length; i++){
                    ...
                    document.write(" name=\"B4\" onclick=\"Javascript: window.location='gpsrmf3.do?familyCode=");
                    document.write(encodeURIComponent(rules[i][1]) + "&subfamilyCode=" + encodeURIComponent(rules[i][2]) + "&scope=" + encodeURIComponent(rules[i][3]) + "&seqNum=" + encodeURIComponent(rules[i][0]));
                    document.write("&productLine=" + escape("${productLineName}"));
                    ...
                    document.write(rules[i][8]);
                    document.write("</span></td><td><span class='dataField'>");
                    document.write(rules[i][9]);
                    document.write("</span></td><td><span class='dataField'>");
