...
<head>
	...
	<title>Galco Parametric Search - Create Rule Set Part 6 - Error</title>
...
<form method="post" action="gpsrmf3.jsp" onsubmit="return My_Validator()" name="form1">
<p>
...
<!-- Logo and Heading  -->
  ...
  <tr>
	...
	<h2>
        Parametric Search Rules Maintenance - Modify Rule Set - Part 6 Error
	</h2>
    </td>
  </tr>
  <tr>
...
<! List the data inconsistencies here -->

<center><h2>
        Pre-existing Parametric Data with Errors
    </h2>
</center>
<p>
    ${booBooCount} &nbsp;error(s) were found.<br/> <br />
...
<p>
The pending changes to this Active Rule Set for this parametric field cannot be saved
until you correct the rules violations for existing part numbers listed above.
If you would like to review or modify the pending changes to the
information in this Rule Set and try again, 
