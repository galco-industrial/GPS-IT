...
<head>
	...
	<title>Galco Parametric Search - Modify Rule Set Part 5</title>
...
function getMessage(divName) {
    ...
    if (divName == "moModify"){return "Click to Modify this Rule Set for this parametric Field.";}
...
<form method="post" action="gpsrmf7.do" onsubmit="return My_Validator()" name="form1">
<p>
...
<!-- Logo and Heading  -->
  ...
  <tr>
	...
	<h2>
        Parametric Search Rules Maintenance - Modify Rule Set - Part 5
	</h2>
    </td>
  </tr>
  <tr>
...
<p>
The Rule Set for this parametric field is or will be set to INACTIVE.
Pre-existing parametric data may or may not be compliant with the current Rule Set.
Click the <font color="FF0000">Modify Rule</font> button below to save these changes.
</p>
