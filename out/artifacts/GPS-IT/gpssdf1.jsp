...
<form name="form1" action="gpssdf2.do" method=post onsubmit="return My_Validator()">
        <p>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Choose the Select Box you wish to Delete and click the Delete button below.
                    </p><br />
                </td>
            </tr>
