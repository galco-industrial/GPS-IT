...
<head>
	...
	<link type="text/css" rel="stylesheet" href="gpsrules.css" />
        ...
        08/23/2007 DES Modified to use Ajax to obtain line/family/subfamily codes
...
function getMessage(divName) {
    ...
    if (divName == "moList") {return "Click to List the Select Boxes for this Family/Subfamily.";}
...
<form name="form1" action="gpsslf2.do" method=post onsubmit="return My_Validator()">
        <p>
