 ...
 * gpsflf1.java
 *
 * Created on February 9, 2007, 5:24 PM
 */
 ...
 *
 * I extract a list of Families from WDS and give them to a JSP to
 * display them in a table sorted by Product Line.
 */

public class gpsflf1 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("gpsflf1.jsp");
            view.forward(request,response);
            productLines = null;
            famCodes = null;
        } catch (Exception e) {
