 ...
 * gpsfnf1.java
 *
 * Created on February 14, 2007, 4:54 PM
 */
 ...
 *
 * *
 * I extract a list of families, arranged in order by Family and Product Line
 * and give them to a JSP to display in preparation for a Renumber operation.
 *
 */
public class gpsfnf1 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        // Build query to extract existing Family codes from the database
