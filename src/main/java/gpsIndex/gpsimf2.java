 ...
 * gpsimf2.java
 *
 * Created on June 23, 2010, 4:12 PM
 */
 ...
 * 
 */
public class gpsimf2 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {    
            ...
            if (completedOK) {
                ...
                request.setAttribute("oldFamilyAlias", familyAlias);
                request.setAttribute("oldSubfamilyAlias", subfamilyAlias);
                ...
                RequestDispatcher view = request.getRequestDispatcher("gpsimf2.jsp");
                view.forward(request,response);
                return;
            }
            conn.close();
