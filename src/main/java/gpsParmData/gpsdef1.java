 ...
 * gpsdef1.java
 *
 * Created on October 9, 2006, 3:47 PM
 */
 ...
 * to gpsdef1.jsp for the user to choose in prep for extracting part data
 */
public class gpsdef1 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            series.add( "\"\",\"Please select a Category first\"" );
