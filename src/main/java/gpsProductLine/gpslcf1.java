 ...
 * gpslcf1.java
 *
 * Created on February 1, 2007, 2:26 PM
 */
 ...
 * @author Sauter
 * @version 1.3.00
 * @title Create Product Line Operation
 *
 * Modified 4/16/2008 by DES to support 4 divisions
 */
public class gpslcf1 extends HttpServlet {
        
    private boolean debugSw = false;
    private final String SERVLET_NAME = "gpslcf1.java";
    ...
    public String getServletInfo() {
        return "I build a Product Lines Object for creating new Product Line Codes.";
    }
    // </editor-fold>
}
