 ...
 * gpsllf1.java
 *
 * Created on February 2, 2007, 4:14 PM
 */
 ...
 * @author Sauter
 * @version 1.3.00
 * @title List product Lines Operation
 *
 * Modified 2008/4/16 by DES to support Division Codes within Product Line
 *
 */
public class gpsllf1 extends HttpServlet {
        
    private boolean debugSw = false;
    private final String SERVLET_NAME = "gpsllf1.java";
    private final String VERSION = "1.2.00";
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (productLines.open(conn) > -1) {
                ...
                RequestDispatcher view = request.getRequestDispatcher("gpsllf1.jsp");
                view.forward(request,response);
            } else {
