 ...
 * gpsrcf3s.java
 *
 * Created on April 27, 2007, 4:08 PM
 */
 ...
 *
 * I store common data in session vars and pass ctrl to jsp to get string rules
 *
 *
 ...
 *
 */
public class gpsrcf3s extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
           ...
           // Now get a list of applicable Select Box Names
            ...
            view = request.getRequestDispatcher("gpsrcf3s.jsp");
            view.forward(request,response);  
        } catch (Exception e){
            conn.close();
