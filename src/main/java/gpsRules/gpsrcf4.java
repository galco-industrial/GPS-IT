 ...
 * gpsrcf4.java
 *
 * Created on April 12, 2007, 5:30 PM
 */
 ...
 *
 * I update session vars and prepare to create, review, or abandon this rule set
 *
...
public class gpsrcf4 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {    
            ...
            view = request.getRequestDispatcher("gpsrcf4.jsp");
            view.forward(request,response); 
        } catch (Exception e){
