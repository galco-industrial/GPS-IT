 ...
 * gpsrmf6s.java
 *
 * Created on November 27, 2007, 4:13 PM
 */
 ...
 * modified rules for this string field.
 *
 */
public class gpsrmf6s extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {    
            ...
            maxLength = ruleSet.getMaxLength();
            ...
            if (rs != null) {
                ...
                while (rs.next()) {
                    ...
                    if (rawValue.length() > 0) {
                        validate = cvt.validateRawStr(rawValue, parmDelimiter, flags, minLength, 
                                maxLength, charSet, sb, "\n");
