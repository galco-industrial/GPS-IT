 ...
 * gpsruf1.java
 *
 * Created on November 30, 2007, 3:02 PM
 */
 ...
 * First I get a list of product lines and xfer to
 * gpsruf1.jsp to get the family, subfamily (scope), and rule set number
 * to be copied.
 *
 */
public class gpsruf1 extends HttpServlet {
    
    private boolean debugSw = false;
    private final String SERVLET_NAME = "gpsruf1.java";
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("gpsruf1.jsp");
            view.forward(request,response);
        } catch (Exception e) {
            e.printStackTrace();
