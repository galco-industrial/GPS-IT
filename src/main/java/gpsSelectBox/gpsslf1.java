 ...
 * gpsslf1.java
 *
 * Created on August 28, 2007, 5:03 PM
 */
 ...
 * an operation to list Select Boxes in a family / subfamily.
 *
 * Major changes made
 * 
 * 08/23/2007   DES
...
public class gpsslf1 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {        
            ...
            RequestDispatcher view = request.getRequestDispatcher("gpsslf1.jsp");
            view.forward(request,response);
        } catch (Exception e) {
