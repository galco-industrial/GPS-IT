 ...
 * gpsodf1.java
 *
 * Created on March 2, 2007, 4:47 PM
 */
 ...
 * @version 1.5.00
 *
 * * Delete List Box Option
 * I extract a list of Select Boxes 
 * from WDS and send them to a JSP to List the Options in a Select Box
 * from which the user can select options to delete.
 * * 
 * 09/01/2007   DES
 ...
 *
 */
public class gpsodf1 extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("gpsodf1.jsp");
            view.forward(request,response);
        } catch (Exception e) {
