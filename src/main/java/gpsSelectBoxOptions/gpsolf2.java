 ...
 * gpsolf2.java
 *
 * Created on February 27, 2007, 5:31 PM
 */
 ...
 * @author Sauter
 *
 * I am called by gpsolf1.jsp when user selects a select box and wishes to list its option.
 * 
 * 09/01/2007   DES
 ...
 */
public class gpsolf2 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            // Invoke our JSP
            RequestDispatcher view = request.getRequestDispatcher("gpsolf2.jsp");
            view.forward(request,response);
        } catch (Exception e) {
            sWork = uStamp + " unexpected error " + e;
            debug (debugLevel, 0, sWork);
