 ...
 * gpsomf1.java
 *
 * Created on March 5, 2007, 5:41 PM
 */
 ...
 * from which the user can select options to modify.
 *
 * * 
 * 09/01/2007   DES
 ...
 *
 */
public class gpsomf1 extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("gpsomf1.jsp");
            view.forward(request,response);
        } catch (Exception e) {
