 ...
 * gpsonf1.java
 *
 * Created on March 6, 2007, 4:22 PM
 */
 ...
 * from WDS and send them to a JSP to renumber the Options in a Select Box.
 * * 
 * 09/01/2007   DES
 ...
 *
 */
public class gpsonf1 extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("gpsonf1.jsp");
            view.forward(request,response);
        } catch (Exception e) {
