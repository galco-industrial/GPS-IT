 ...
 * gpsotf1.java
 *
 * Created on July 26, 2010, 4:48 PM
 */
 ...
 * Then I allow the user to enable/disable image display mode
 * 
 * 09/01/2007   DES
...
public class gpsotf1 extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("gpsotf1.jsp");
            view.forward(request,response);
        } catch (Exception e) {
