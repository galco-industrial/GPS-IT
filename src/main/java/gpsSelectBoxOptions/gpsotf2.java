 ...
 * gpsotf2.java
 *
 * Created on July 26, 2010, 4:56 PM
 */
 ...
 * @author Sauter
 *
 * I am called by gpsotf1.jsp when user selects a select box and wishes to enable/disable images.
 * 
 * 09/01/2007   DES
...
public class gpsotf2 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            size = selectBox.size();
            showImages = selectBox.showImages() ? "SHOW" : "HIDE";
