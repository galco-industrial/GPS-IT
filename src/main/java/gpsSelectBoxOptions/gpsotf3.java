 ...
 *
 */
public class gpsotf3 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (selectBox.open(conn, familyCode, subfamilyCode, selectBoxName) > -1) {
                ...
                String familyName = GPSfamilyCodes.lookUpFamilyName(conn, familyCode);
                String subfamilyName = GPSsubfamilyCodes.lookUpSubfamilyName(conn, familyCode, subfamilyCode);                
                String imagePath = "";
                String imageURLBase = "";
                String fileStatus = "";
                ...
                request.setAttribute("familyName", familyName); //(String) session.getAttribute("sbFamilyName"));
                ...
                request.setAttribute("subfamilyName", subfamilyName); //(String) session.getAttribute("sbSubfamilyName"));
            
                RequestDispatcher view = request.getRequestDispatcher("gpsotf3.jsp");
                view.forward(request,response);
            } else {
                conn.close();
