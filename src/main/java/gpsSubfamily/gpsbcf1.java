 ...
 * gpsbcf1.java
 *
 * Created on February 16, 2007, 4:17 PM
 */
 ...
 *
 * I obtain a list of Product Lines that have at least one Family Code assigned
 * and pass it to gpsbcf1.jsp
 *
 */
public class gpsbcf1 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        // Build query to extract existing Product Lines, Family codes 
        ...
        try {
            ...
            request.setAttribute("statusMessage", ""); // "Create Operation" Completion Code Message
