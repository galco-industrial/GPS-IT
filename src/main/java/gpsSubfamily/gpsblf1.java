 ...
 * gpsblf1.java
 *
 * Created on February 20, 2007, 4:35 PM
 */
 ...
 * and give them to a JSP to display
 *
 */
public class gpsblf1 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("gpsblf1.jsp");
            view.forward(request,response);
        } catch (Exception e) {
