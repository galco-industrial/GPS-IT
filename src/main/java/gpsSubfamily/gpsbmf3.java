 ...
 * gpsbmf3.java
 *
 * Created on February 21, 2007, 1:46 PM
 */
 ...
 *
 * I obtain the Subfamily Code to be modified and pass the info to
 * gpsbmf2.jsp to display the modification form.
 *
 * * Modified 9/29/2010 by DES to support division CP
 *
 */
public class gpsbmf3 extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        // in prep for a call to the update JSP
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("gpsbmf3.jsp");
            view.forward(request,response);
        } catch (Exception e) {
