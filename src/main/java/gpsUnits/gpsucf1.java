 ...
 * gpsucf1.java
 *
 * Created on March 9, 2007, 3:40 PM
 */
 ...
 * @version 1.5.00
 *
 * I extract the records from the ps_units table for gpsucf1.jsp
 * Then the user will select the base units for the new Unit being added.
 *
 */
public class gpsucf1 extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("gpsucf1.jsp");
            view.forward(request,response);
        } catch (Exception e) {
