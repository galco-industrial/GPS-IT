 ...
 * gpsudf1.java
 *
 * Created on March 19, 2007, 5:57 PM
 */
 ...
 * @version 1.5.00
 *
 * I extract the records from the ps_units table for gpsudf1.jsp
 * Then the user will select the Unit to be deleted.
 *
 */
public class gpsudf1 extends HttpServlet {
