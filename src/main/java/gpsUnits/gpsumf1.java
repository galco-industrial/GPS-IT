 ...
 * gpsumf1.java
 *
 * Created on March 14, 2007, 1:07 PM
 */
 ...
 * @version 1.5.00
 * *
 * I extract the records from the ps_units table for gpsumf1.jsp
 * Then the user will select the Unit to be modified.
 *
 */
public class gpsumf1 extends HttpServlet {
