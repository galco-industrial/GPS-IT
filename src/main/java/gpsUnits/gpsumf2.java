 ...
 * gpsumf2.java
 *
 * Created on March 14, 2007, 1:49 PM
 */
 ...
 *
 * *
 * I am called by gpsumf1.jsp when user wants to modify a Unit.
 * I pass existing Units and related details to gpsumf2.jsp
 */
 
public class gpsumf2 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (displayUnits.equals(unit.getBaseUnits())) {
                view = request.getRequestDispatcher("gpsumf2.jsp");
            } else {
                view = request.getRequestDispatcher("gpsumf2a.jsp");
            }
            view.forward(request,response);
        } catch (Exception e) {
            sWork = uStamp + " unexpected error " + e;
