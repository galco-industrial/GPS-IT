...
function getMessage(divName) {
    ...
    if (divName == "moContinue"){return "Click continue to finish adding this item.";}
    if (divName == "moExit"){return "Click to abandon this operation and return to the previous Menu.";}
    if (divName == "moFamily") {return "Select a Product Family.";}
    if (divName == "moProductLine"){return "Please select a Product Line.";}
    if (divName == "moReset"){return "Click Reset to return the form to its initial state when first displayed.";} 
    if (divName == "moSubfamily") {return "Select a Product Subfamily.";}
    return "";
}
...
<body onload="setDefaults()">
    ...
    <!--
        ...
        var prevLine = "${sessionScope.productLineCode}";
        var prevFamily = "${sessionScope.familyCode}";
        var prevSubfamily = "${sessionScope.subfamilyCode}";
...
<form name="form1" action="gpsdaf2.do" method="post" onsubmit="return My_Validator()">
    <p>
            <input type="hidden" name="validation" value="Error" />
            <input type="hidden" name="productLineName" value="${sessionScope.productLineName}" />
            <input type="hidden" name="familyName" value="${sessionScope.familyName}" />
            <input type="hidden" name="subfamilyName" value="${sessionScope.subfamilyName}" />
    </p>
        ...
        <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Choose a Product Line, Family and Subfamily for the parametric data you wish to enter.
                    </p><br />
                </td>
            </tr>
