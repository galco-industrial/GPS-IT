...
<head>
	...
	<title>Galco Parametric Search - Create Index Alias</title>
...
function getMessage(divName) {
    ...
    if (divName == "moCreate") {return "Click Create to add this Index Alias.";}
    ...
    if (divName == "moFamilyAlias") {return "Enter up to 36 alphanumeric characters.";}
    ...
    if (divName == "moSubfamilyAlias") {return "Enter up to 36 alphanumeric characters.";}
    return "";
}
...
function My_Validator() {
    ...
    work = myForm.familyAlias.value;
    if (work.length == 0) {
        alert ("Please enter a valid Index Family Alias Name.");
        myForm.familyAlias.focus();
        return false;
    }
        
    work = myForm.subfamilyAlias.value;
    if (work.length == 0) {
        alert ("Please enter a valid Index Subfamily Alias Name.");
        myForm.subfamilyAlias.focus();
        return false;
    }
...
<body onload="setDefaults()">
    ...
    <!--
        ...
        var prevLine = "${sessionScope.aiProductLineCode}";
        var prevFamily = "${sessionScope.aiFamilyCode}";
        var prevSubfamily = "${sessionScope.aiSubfamilyCode}";
...
<form name="form1" action="gpsicf2.do" method=post onsubmit="return My_Validator()">
        <p>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>An Index Family alias and/or Subfamily Alias can be up to
                    36 alphanumeric characters and dashes.
                    </p><br />
                </td>
            </tr>
...
<!-- Index Family Alias  -->
            ...
            <tr>
                <td align="right">
                    <span class="requiredLabel">Alias Family Name:&nbsp;</span>
                </td>
                <td align="left">
                    <span class="dataField">
  ...
  <!-- Index Subfamily Alias  -->
            ...
            <tr>
                <td align="right">
                    <span class="label">Alias Subfamily Name:&nbsp;</span>
                </td>
                <td align="left">
                    <span class="dataField">
