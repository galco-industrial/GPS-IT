...
function getMessage(divName) {
    ...
    if (divName == "moContinue") {return "Click Continue to Modify an Option in a Select Box.";}
    ...
    if (divName == "moSelectBoxName") {return "Choose a Select Box that contains the Option.";}
...
<form name="form1" action="gpsomf2.do" method="post" onsubmit="return My_Validator()">
        <p>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>First choose a Select Box that contains the Option(s) you wish to Modify.
                    </p><br />
                </td>
            </tr>
