...
function getMessage(divName) {
    ...
    if (divName == "moContinue") {return "Click Continue to view the Options you wish to Renumber.";}
    ...
    if (divName == "moSelectBoxName") {return "Choose a Select Box that contains the Options you wish to renumber.";}
...
<form name="form1" action="gpsonf2.do" method="post" onsubmit="return My_Validator()">
    <p>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Choose a Select Box whose Options you wish to Renumber.
                    </p><br />
                </td>
            </tr>
