...
function getMessage(divName) {
    ...
    if (divName == "moList") {return "Click to Continue.";}
    if (divName == "moProductLine") {return "Select a Product Line from this list.";}
    if (divName == "moSelectBoxName") {return "Choose a Select Box whose Options you wish to List.";}
...
<form name="form1" action="gpsotf2.do" method=post onsubmit="return My_Validator()">
        <p>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Choose a Select Box whose Images you wish to Enable/Disable.
                    </p><br />
                </td>
            </tr>
