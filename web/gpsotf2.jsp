...
<head>
	...
	<title>Galco Parametric Search - Enable/Disable Select Box Images</title>
...
function getMessage(divName) {
    ...
    if (divName == "moHide") {return "Click to hide the images for this select box.";}
    ...
    if (divName == "moShow") {return "Click to Show the images for this select box.";}
...
<form name="form1" action="gpsotf4.do" method="post" onsubmit="return My_Validator()" >
<p>
...
%> 
			...
			Enable/Disable Select Box Images
                </h2>
            </td>
        </tr>
                <tr>
...
<!--
    ...
    if (totalImages == 0) {
        ...
        document.write("No Options with Images currently exist in this Select Box.");
        document.write("</h3>");
    } else {
        document.write("<h3 align=\"center\">");
        document.write("" + totalImages + " Options with Images currently exist in this Select Box.");
        document.write("</h3><br /><h3 align='center'>");
        if (document.form1.showImages.value == "SHOW") {
            document.write("Images are currently shown for this Select Box.");
            document.write("</h3><p align='center'>");
            document.write("<input type='submit' value='Hide Images' name='toggle' ");
            document.write("onmouseover=\"showTip(event, 'moHide')\" "); 
            document.write("onmouseout=\"hideTip()\" />");
        } else {
            document.write("Images are currently hidden for this Select Box.");
            document.write("</h3><p align='center'>");
            document.write("<br /><input type='submit' value='Show Images' name='toggle' ");
            document.write("onmouseover=\"showTip(event, 'moShow')\" "); 
            document.write("onmouseout=\"hideTip()\" />");
        }
        document.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='button' value='&nbsp;&nbsp;&nbsp;&nbsp;Exit&nbsp;&nbsp;&nbsp;&nbsp;' name='B7' ");
        document.write("onclick=\"Javascript: window.location='gpsotf1.do';\" ");
        document.write("onmouseover=\"showTip(event, 'moExit')\" ");
        document.write("onmouseout='hideTip()' />");
        document.write("</p><br />");
    }
...
<!--
                for (var i = 0; i < options.length; i++){
                    ...
                    document.write(" name=\"B4\" onclick=\"Javascript: window.location='gpsotf3.do?selectBoxName=");
...
<p>
    <center>
        <input type="button" value="&nbsp;&nbsp;&nbsp;&nbsp;Exit&nbsp;&nbsp;&nbsp;&nbsp;" name="B3" onclick="Javascript: window.location='gpsotf1.do'; " 
