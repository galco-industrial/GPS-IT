...
<head>
	...
	<title>Galco Parametric Search - Create Rule Set</title>
	<link type="text/css" rel="stylesheet" href="gpsrules.css" />
        ...
        09/06/2007      DES     Modified to use Ajax to obtain 
...
function getMessage(divName) {
    ...
    if (divName == "moContinue") {return "Click Continue to create more Rules for this field.";}
...
%> 
			...
			Create Family/Subfamily Rule Set
                </h2>
            </td>
        </tr>
        <tr>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Select the Product Line/Family/Subfamily codes for the field you wish to create.
                    </p><br />
                </td>
            </tr>
