...
function getMessage(divName) {
    ...
    if (divName == "moContinue") {return "Click Continue to select a field Rule Set to Modify.";}
    ...
    if (divName == "moSubfamily") {return "To Modify a Local rule, select a Product Subfamily from this list.";}
    return "";
}
...
<form name="form1" action="gpsrmf2.do" method="post" onsubmit="return My_Validator()">
        <p>
...
%> 
			...
			Modify Family (Global)/Subfamily (Local) Rule Set
                </h2>
            </td>
        </tr>
        <tr>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Select the Product Line/Family/Subfamily codes for the field you wish to Modify.
                    </p><br />
                </td>
            </tr>
