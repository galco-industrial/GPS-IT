...
<head>
	...
	<title>Galco Parametric Search - Modify Rule Set - Part 2</title>
...
function getMessage(divName) {
    if (divName == "header"){return "You cannot change the Rule Scope, Line/Family/Subfamily name, or the Field Number.";}
    if (divName == "moContinue"){return "Click to continue with changes to this field's rule set.";}
...
function My_Validator() {
    ...
    myForm.action = "gpsrmf4" + work.toLowerCase() + ".do";
...
<!-- Logo and Heading  -->
  ...
  <tr>
    <td align="center" colspan="2">
      <h2>
        Parametric Search Rules Maintenance - Modify Rule Set- Part 2
      </h2>
    </td>
  </tr>
  <tr>
