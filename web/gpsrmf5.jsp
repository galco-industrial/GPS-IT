...
<head>
	...
	<title>Galco Parametric Search - Modify Rule Set Part 4</title>
...
<!-- Logo and Heading  -->
  ...
  <tr>
	...
	<h2>
        Parametric Search Rules Maintenance - Modify Rule Set - Part 4
	</h2>
    </td>
  </tr>
  <tr>
...
<hr />
<br />
<form method="post" action="#" name="form2" onsubmit="return My_Validator2()">
<p>
	<input type="hidden" 
            name="validation2" 
            value="OK" 
