...
function getMessage(divName) {
    ...
    if (divName == "moContinue") {return "Click Continue to read a Rule Set.";}
...
<form name="form1" action="gpsrrf2.do" method=post onsubmit="return My_Validator()">
        <p>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Select the Product Line for the Product Family/Subfamily Rule Set you wish to Read.
                    </p><br />
                </td>
            </tr>
