...
function getMessage(divName) {
    ...
    if (divName == "moClick") {return "Click to display the Rule Set for this field.";}
...
%> 
			...
			Read Family/Subfamily Rule Set
                </h2>
            </td>
        </tr>
        <tr>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Click the desired Rule to Display it.
                    </p><br />
                </td>
            </tr>
...
<!--
            if (rules.length > 0) {
                for (var i = 0; i < rules.length; i++){
                    ...
                    document.write(" name=\"B4\" onclick=\"Javascript: window.location='gpsrrf3.do?familyCode=");
