...
function getMessage(divName) {
    ...
    if (divName == "moClick") {return "Click to Copy the Rule Set for this field.";}
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Click the Rule Set you wish to Copy.
                    </p><br />
                </td>
            </tr>
...
<!-- Product Subfamily -->
    ...
    <table border="1" align="center" width="100%">
            ...
            <tr>
                <td width="5%">
                    <span class="requiredLabel">Click to<br />Copy</span>
                </td>
                <td width="5%">
...
<!--
            if (rules.length > 0) {
                for (var i = 0; i < rules.length; i++){
                    ...
                    document.write(" name=\"B4\" onclick=\"Javascript: window.location='gpsruf3.do?familyCode=");
