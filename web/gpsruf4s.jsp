...
<head>
	...
	<title>Galco Parametric Search - Copy Rule Set Part 3S</title>
...
function getMessage(divName) {
    if (divName == "header"){return "You cannot the Rule Scope, Line/Family/Subfamily name, Data Type, or the Field Number here.";}
    ...
    if (divName == "moContinue"){return "Click to finish Copying this rule set.";}
...
<!-- Logo and Heading  -->
  ...
  <tr>
	...
	<h2>
        Parametric Search Rules Maintenance - Copy Rule Set - Part 3S
	</h2>
    </td>
  </tr>
  <tr>
