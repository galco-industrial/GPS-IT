...
<form name="form1" action="gpssrf2.do" method=post onsubmit="return My_Validator()">
        <p>
    ...
    <table border="0" align="center" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <p>Choose the Select Box you wish to Rename and click the Rename button below.
                    </p><br />
                </td>
            </tr>
